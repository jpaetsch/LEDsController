 ...
 **/
public class LEDsBluetoothServiceJAVA extends Service {
    private static final String TAG = "LEDsBluetoothServiceJAVA";
    ...
    public class LEDBinder extends Binder {
        LEDsBluetoothServiceJAVA getService() {
            return LEDsBluetoothServiceJAVA.this;
        }
    }
